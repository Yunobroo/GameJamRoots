    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(V i):SV_Target
            {
                ...
                float3 cell=floor(i.world*9);
                half chips=sin(i.world.x*37+sin(i.world.y*23))*sin(i.world.z*31+i.world.y*29)*0.5+0.5;
                half rust=smoothstep(0.79,0.97,chips);
                half damp=saturate(sin(i.world.x*2.3+i.world.z*1.7)*0.5+0.35);
                paint=lerp(paint,half3(0.15,0.075,0.035),rust*0.72);
                paint*=1-damp*0.22;
                half accent=smoothstep(0.23,0.38,source.r-source.g) * (1-smoothstep(0.24,0.32,value));
